...
var Particle = function () {
  ...
  */
   ...
   */
		...
		key: 'createUser',
		value: function createUser(_ref4) {
   ...
   */
		...
		key: 'verifyUser',
		value: function verifyUser(_ref5) {
   ...
   */
		...
		key: 'resetPassword',
		value: function resetPassword(_ref6) {
   ...
   */
		...
		value: function deleteAccessToken(_ref7) {
   ...
   */
		...
		value: function deleteCurrentAccessToken(_ref8) {
			var auth = _ref8.auth,
   ...
   */
		...
		value: function listAccessTokens(_ref9) {
   ...
   */
		...
		value: function trackingIdentity() {
			var _ref10 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
			    auth = _ref10.auth,
			    _ref10$full = _ref10.full,
			    full = _ref10$full === undefined ? false : _ref10$full,
   ...
   */
		...
		key: 'listDevices',
		value: function listDevices(_ref11) {
			var deviceId = _ref11.deviceId,
			    deviceName = _ref11.deviceName,
			    sortAttr = _ref11.sortAttr,
			    sortDir = _ref11.sortDir,
			    page = _ref11.page,
			    perPage = _ref11.perPage,
   ...
   */
		...
		key: 'getDevice',
		value: function getDevice(_ref12) {
   ...
   */
		...
		key: 'claimDevice',
		value: function claimDevice(_ref13) {
			var deviceId = _ref13.deviceId,
			    requestTransfer = _ref13.requestTransfer,
			    auth = _ref13.auth,
   ...
   */
		...
		value: function addDeviceToProduct(_ref14) {
   ...
   */
		...
		key: 'removeDevice',
		value: function removeDevice(_ref15) {
   ...
   */
		...
		value: function removeDeviceOwner(_ref16) {
   ...
   */
		...
		key: 'renameDevice',
		value: function renameDevice(_ref17) {
   ...
   */
		...
		key: 'signalDevice',
		value: function signalDevice(_ref18) {
   ...
   */
		...
		key: 'setDeviceNotes',
		value: function setDeviceNotes(_ref19) {
   ...
   */
		...
		value: function markAsDevelopmentDevice(_ref20) {
			var deviceId = _ref20.deviceId,
			    _ref20$development = _ref20.development,
			    development = _ref20$development === undefined ? true : _ref20$development,
   ...
   */
		...
		value: function lockDeviceProductFirmware(_ref21) {
   ...
   */
		...
		value: function unlockDeviceProductFirmware(_ref22) {
   ...
   */
		...
		key: 'updateDevice',
		value: function updateDevice(_ref23) {
			var deviceId = _ref23.deviceId,
			    name = _ref23.name,
			    signal = _ref23.signal,
			    notes = _ref23.notes,
			    development = _ref23.development,
			    desiredFirmwareVersion = _ref23.desiredFirmwareVersion,
			    flash = _ref23.flash,
   ...
   */
		...
		key: 'provisionDevice',
		value: function provisionDevice(_ref24) {
			var productId = _ref24.productId,
			    auth = _ref24.auth,
   ...
   */
		...
		key: 'getClaimCode',
		value: function getClaimCode(_ref25) {
			var iccid = _ref25.iccid,
		...
		value: function validatePromoCode(_ref26) {
			var auth = _ref26.auth,
			    promoCode = _ref26.promoCode,
		...
		key: 'changeProduct',
		value: function changeProduct(_ref27) {
   ...
   */
		...
		key: 'getVariable',
		value: function getVariable(_ref28) {
   ...
   */
		...
		key: 'flashDevice',
		value: function flashDevice(_ref29) {
   ...
   */
		...
		key: 'flashTinker',
		value: function flashTinker(_ref30) {
   ...
   */
		...
		key: 'compileCode',
		value: function compileCode(_ref31) {
			var files = _ref31.files,
			    platformId = _ref31.platformId,
   ...
   */
		...
		value: function downloadFirmwareBinary(_ref32) {
			var binaryId = _ref32.binaryId,
			    auth = _ref32.auth,
   ...
   */
		...
		key: 'sendPublicKey',
		value: function sendPublicKey(_ref33) {
			var deviceId = _ref33.deviceId,
			    key = _ref33.key,
			    algorithm = _ref33.algorithm,
			    auth = _ref33.auth,
   ...
   */
		...
		key: 'callFunction',
		value: function callFunction(_ref34) {
			var deviceId = _ref34.deviceId,
			    name = _ref34.name,
			    argument = _ref34.argument,
   ...
   */
		...
		key: 'getEventStream',
		value: function getEventStream(_ref35) {
   ...
   */
		...
		key: 'publishEvent',
		value: function publishEvent(_ref36) {
			var name = _ref36.name,
			    data = _ref36.data,
			    isPrivate = _ref36.isPrivate,
   ...
   */
		...
		key: 'createWebhook',
		value: function createWebhook(_ref37) {
			var deviceId = _ref37.deviceId,
			    name = _ref37.name,
			    url = _ref37.url,
			    requestType = _ref37.requestType,
			    headers = _ref37.headers,
			    json = _ref37.json,
			    query = _ref37.query,
			    body = _ref37.body,
			    responseTemplate = _ref37.responseTemplate,
			    responseTopic = _ref37.responseTopic,
			    rejectUnauthorized = _ref37.rejectUnauthorized,
			    webhookAuth = _ref37.webhookAuth,
			    noDefaults = _ref37.noDefaults,
			    form = _ref37.form,
   ...
   */
		...
		key: 'deleteWebhook',
		value: function deleteWebhook(_ref38) {
			var hookId = _ref38.hookId,
   ...
   */
		...
		key: 'listWebhooks',
		value: function listWebhooks(_ref39) {
			var product = _ref39.product,
			    auth = _ref39.auth,
   ...
   */
		...
		value: function createIntegration(_ref40) {
			var integrationType = _ref40.integrationType,
			    event = _ref40.event,
			    settings = _ref40.settings,
   ...
   */
		...
		key: 'editIntegration',
		value: function editIntegration(_ref41) {
			var integrationId = _ref41.integrationId,
			    event = _ref41.event,
			    settings = _ref41.settings,
   ...
   */
		...
		value: function deleteIntegration(_ref42) {
			var integrationId = _ref42.integrationId,
   ...
   */
		...
		value: function listIntegrations(_ref43) {
   ...
   */
		...
		key: 'getUserInfo',
		value: function getUserInfo(_ref44) {
			var auth = _ref44.auth,
   ...
   */
		...
		key: 'setUserInfo',
		value: function setUserInfo(_ref45) {
			var stripeToken = _ref45.stripeToken,
			    accountInfo = _ref45.accountInfo,
			    password = _ref45.password,
			    auth = _ref45.auth,
   ...
   */
		...
		key: 'listSIMs',
		value: function listSIMs(_ref46) {
			var iccid = _ref46.iccid,
			    deviceId = _ref46.deviceId,
			    deviceName = _ref46.deviceName,
			    page = _ref46.page,
			    perPage = _ref46.perPage,
   ...
   */
		...
		key: 'getSIMDataUsage',
		value: function getSIMDataUsage(_ref47) {
   ...
   */
		...
		value: function getFleetDataUsage(_ref48) {
		...
		key: 'checkSIM',
		value: function checkSIM(_ref49) {
   ...
   */
		...
		key: 'activateSIM',
		value: function activateSIM(_ref50) {
			var iccid = _ref50.iccid,
			    iccids = _ref50.iccids,
			    country = _ref50.country,
			    promoCode = _ref50.promoCode,
   ...
   */
		...
		key: 'deactivateSIM',
		value: function deactivateSIM(_ref51) {
   ...
   */
		...
		key: 'reactivateSIM',
		value: function reactivateSIM(_ref52) {
			var iccid = _ref52.iccid,
			    mbLimit = _ref52.mbLimit,
   ...
   */
		...
		key: 'updateSIM',
		value: function updateSIM(_ref53) {
			var iccid = _ref53.iccid,
			    mbLimit = _ref53.mbLimit,
   ...
   */
		...
		key: 'removeSIM',
		value: function removeSIM(_ref54) {
   ...
   */
		...
		value: function listBuildTargets(_ref55) {
			var onlyFeatured = _ref55.onlyFeatured,
			    auth = _ref55.auth,
   ...
   */
		...
		key: 'listLibraries',
		value: function listLibraries(_ref56) {
			var page = _ref56.page,
			    limit = _ref56.limit,
			    filter = _ref56.filter,
			    sort = _ref56.sort,
			    architectures = _ref56.architectures,
			    category = _ref56.category,
			    scope = _ref56.scope,
			    excludeScopes = _ref56.excludeScopes,
			    auth = _ref56.auth,
   ...
   */
		...
		key: 'getLibrary',
		value: function getLibrary(_ref57) {
			var name = _ref57.name,
			    version = _ref57.version,
			    auth = _ref57.auth,
   ...
   */
		...
		value: function getLibraryVersions(_ref58) {
   ...
   */
		...
		value: function contributeLibrary(_ref59) {
			var archive = _ref59.archive,
			    auth = _ref59.auth,
   ...
   */
		...
		key: 'publishLibrary',
		value: function publishLibrary(_ref60) {
   ...
   */
		...
		key: 'deleteLibrary',
		value: function deleteLibrary(_ref61) {
   ...
   */
		...
		key: 'downloadFile',
		value: function downloadFile(_ref62) {
			var url = _ref62.url;
   ...
   */
		...
		value: function listOAuthClients(_ref63) {
			var product = _ref63.product,
			    auth = _ref63.auth,
   ...
   */
		...
		value: function createOAuthClient(_ref64) {
			var name = _ref64.name,
			    type = _ref64.type,
			    redirect_uri = _ref64.redirect_uri,
			    scope = _ref64.scope,
   ...
   */
		...
		value: function updateOAuthClient(_ref65) {
			var clientId = _ref65.clientId,
			    name = _ref65.name,
			    scope = _ref65.scope,
			    product = _ref65.product,
			    auth = _ref65.auth,
   ...
   */
		...
		value: function deleteOAuthClient(_ref66) {
			var clientId = _ref66.clientId,
			    product = _ref66.product,
			    auth = _ref66.auth,
   ...
   */
		...
		key: 'listProducts',
		value: function listProducts(_ref67) {
			var auth = _ref67.auth,
   ...
   */
		...
		key: 'getProduct',
		value: function getProduct(_ref68) {
			var product = _ref68.product,
			    auth = _ref68.auth,
   ...
   */
		...
		value: function listProductFirmware(_ref69) {
   ...
   */
		...
		value: function uploadProductFirmware(_ref70) {
			var file = _ref70.file,
			    version = _ref70.version,
			    title = _ref70.title,
   ...
   */
		...
		value: function getProductFirmware(_ref71) {
   ...
   */
		...
		value: function updateProductFirmware(_ref72) {
			var version = _ref72.version,
			    title = _ref72.title,
			    description = _ref72.description,
   ...
   */
		...
		value: function downloadProductFirmware(_ref73) {
			var version = _ref73.version,
   ...
   */
		...
		value: function releaseProductFirmware(_ref74) {
			var version = _ref74.version,
   ...
   */
		...
		key: 'listTeamMembers',
		value: function listTeamMembers(_ref75) {
   ...
   */
		...
		value: function inviteTeamMember(_ref76) {
			var username = _ref76.username,
   ...
   */
		...
		value: function removeTeamMember(_ref77) {
			var username = _ref77.username,
   ...
   */
		...
		value: function lookupSerialNumber(_ref78) {
			var serialNumber = _ref78.serialNumber,
			    auth = _ref78.auth,
   ...
   */
		...
		key: 'deviceUri',
		value: function deviceUri(_ref79) {
			var deviceId = _ref79.deviceId,
